      ...
      return (
        ...
        (a._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              (!t && n.toggle && /show|hide/.test(i) && (n.toggle = !1), t || ((t = new a(this, n)), e.data(fe, t)), 'string' == typeof i)
            ) {
      ...
      modifiers: {
              ...
              u = {
                ...
                secondary: function (e) {
                  var t = 'right' === e ? 'left' : 'top',
                    n = h[t];
                  return (
                    h[e] > l[e] && !i.escapeWithReference && (n = Math.min(h[t], l[e] - ('right' === e ? h.width : h.height))), Ye({}, t, n)
                  );
                },
              };
            return (
        ...
        inner: {
          ...
          fn: function (e) {
            ...
            return (
              (o[s ? 'left' : 'top'] = r[n] - (a ? o[s ? 'width' : 'height'] : 0)), (e.placement = it(t)), (e.offsets.popper = Xe(o)), e
            );
          },
        },
        hide: {
