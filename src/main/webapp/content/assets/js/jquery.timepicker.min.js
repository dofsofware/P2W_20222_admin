...
!(function (a) {
  'object' == typeof exports && exports && 'object' == typeof module && module && module.exports === exports
    ? a(require('jquery'))
  ...
  function c(b) {
    ...
    if (
      ('string' === a.type(b.timeFormat) && b.timeFormat.match(/[gh]/) && (b._twelveHourTime = !0),
      b.showOnFocus === !1 && -1 != b.showOn.indexOf('focus') && b.showOn.splice(b.showOn.indexOf('focus'), 1),
  ...
  function e(b, c) {
    ...
    return (
      ...
      c ? a('<option />', { value: f, class: e, text: d }) : a('<li />', { class: e, text: d }).data('time', String(f))
    );
  }
  function f(a, b) {
  ...
  function g(b) {
    if (b.target != window) {
      ...
      c.closest('.ui-timepicker-input').length ||
        ...
        (y.hide(), a(document).unbind('.ui-timepicker'), a(window).unbind('.ui-timepicker'));
    }
  }
  function h(a) {
  ...
  function j(a, b) {
    ...
    if (null !== d) {
      ...
      if (e) {
        ...
        (f + e.outerHeight() > b.outerHeight() || 0 > f) && b.scrollTop(b.scrollTop() + e.position().top - e.outerHeight()),
  ...
  function k(b, c) {
    if ('timepicker' != c) {
      ...
      if (!d.is(':focus') || (b && 'change' == b.type)) {
        ...
        var g = !1;
        if (
          (null !== e.minTime && null !== e.maxTime && (f < e.minTime || f > e.maxTime) && (g = !0),
  ...
  function m(a, b, c) {
    ...
    return a.data('ui-timepicker-value') != b
      ? (a.data('ui-timepicker-value', b),
        'select' == c
          ? a.trigger('selectTime').trigger('changeTime').trigger('change', 'timepicker')
        ...
        return (
          f.length
            ? f.is(':first-child') ||
              ...
              f.prev().position().top < f.outerHeight() && e.scrollTop(e.scrollTop() - f.outerHeight()))
  ...
  function q(a) {
    ...
    return e.hasClass('ui-timepicker-disabled')
      ? !1
      : (e.length && (d = e.data('time')), null !== d && ('string' != typeof d && (d = s(d, b)), m(a, d, 'select')), !0);
  }
  function r(a, b) {
    a = Math.abs(a);
    var c,
  ...
  var v = 86400,
    ...
    y = {
      ...
      show: function (c) {
        ...
        if (
          !e.prop('readonly') &&
          ((k && 0 !== k.length && 'function' != typeof f.durationTime) || (d(e), (k = e.data('timepicker-list'))), !b(k))
        ) {
          e.data('ui-timepicker-value', e.val()), j(e, k), y.hide(), k.show();
          var m = {};
          f.orientation.match(/r/)
            ? (m.left = e.offset().left + e.outerWidth() - k.outerWidth() + parseInt(k.css('marginLeft').replace('px', ''), 10))
            : (m.left = e.offset().left + parseInt(k.css('marginLeft').replace('px', ''), 10));
          var n;
          (n = f.orientation.match(/t/)
            ? 't'
            : f.orientation.match(/b/)
            ? 'b'
            : e.offset().top + e.outerHeight(!0) + k.outerHeight() > a(window).height() + a(window).scrollTop()
            ? 't'
            : 'b'),
            't' == n
              ? (k.addClass('ui-timepicker-positioned-top'),
                (m.top = e.offset().top - k.outerHeight() + parseInt(k.css('marginTop').replace('px', ''), 10)))
          ...
          if (
            ((!o.length || o.hasClass('ui-timepicker-disabled')) && (o = k.find('li:not(.ui-timepicker-disabled):first')), o && o.length)
          ) {
          ...
          return (
            f.stopScrollPropagation &&
              a(document).on('wheel.ui-timepicker', '.ui-timepicker-wrapper', function (b) {
                b.preventDefault();
