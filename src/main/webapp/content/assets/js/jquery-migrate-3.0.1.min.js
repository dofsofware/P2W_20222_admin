  ...
  (function (e) {
    ...
    function r(r) {
      ...
      o[r] ||
        ...
        n && n.warn && !e.migrateMute && (n.warn('JQMIGRATE: ' + r), e.migrateTrace && n.trace && n.trace()));
    }
    function n(e, t, n, a) {
    ...
    (e.migrateVersion = '3.0.1'),
      (function () {
        ...
        t.console &&
          ...
          t.console.log(
            'JQMIGRATE: Migrate is installed' + (e.migrateMute ? '' : ' with logging active') + ', version ' + e.migrateVersion
          ));
      })();
    var o = {};
    (e.migrateWarnings = []),
    ...
    (e.Tween.prototype.run = function () {
      e.easing[this.easing].length > 1 &&
        (r("'jQuery.easing." + this.easing.toString() + "' should use only one argument"), (e.easing[this.easing] = j)),
    ...
    (e.event.props = []),
      ...
      (e.event.fix = function (t) {
        ...
        if (
          o &&
          !o._migrated_ &&
          ((o._migrated_ = !0), r('jQuery.event.fixHooks are deprecated and removed: ' + a), (i = o.props) && i.length)
        )
      ...
      e.each(
        ...
        function (t, n) {
          e.fn[n] = function (e, t) {
            return (
              r('jQuery.fn.' + n + '() event shorthand is deprecated'), arguments.length > 0 ? this.on(n, null, e, t) : this.trigger(n)
            );
          };
        }
      ),
    ...
    e.fn.offset = function () {
      ...
      return a && a.nodeType
        ? ((n = (a.ownerDocument || t.document).documentElement),
          e.contains(n, a) ? x.apply(this, arguments) : (r('jQuery.fn.offset() requires an element connected to a document'), o))
