...
describe('Incription Management Component', () => {
  let comp: IncriptionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(IncriptionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.incriptions[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
