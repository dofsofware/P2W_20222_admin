...
export class ProfilComponent implements OnInit {
  ...
  constructor(protected profilService: ProfilService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.profils = [];
    ...
    this.profilService
      ...
      .subscribe({
        next: (res: HttpResponse<IProfil[]>) => {
          ...
          this.paginateProfils(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  trackId(_index: number, item: IProfil): number {
    return item.id!;
  }
  ...
  protected paginateProfils(data: IProfil[] | null, headers: HttpHeaders): void {
