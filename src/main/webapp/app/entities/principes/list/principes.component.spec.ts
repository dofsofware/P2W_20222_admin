...
describe('Principes Management Component', () => {
  let comp: PrincipesComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PrincipesComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.principes[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
