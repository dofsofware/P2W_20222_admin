...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.techxel.play2win_admin.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.techxel.play2win_admin.repository.UserRepository.USERS_BY_EMAIL_CACHE);
