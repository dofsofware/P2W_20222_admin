...
/**
 * REST controller for managing {@link com.techxel.play2win_admin.domain.Play}.
 */
@RestController
@RequestMapping("/api")
public class PlayResource {
    ...
    public ResponseEntity<Play> updatePlay(@PathVariable(value = "id", required = false) final Long id, @RequestBody Play play)
        ...
        Play result = playService.update(play);
        return ResponseEntity
            .ok()
     ...
     */
    @GetMapping("/plays")
    public ResponseEntity<List<Play>> getAllPlays(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
